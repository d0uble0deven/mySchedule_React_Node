...
// export async function asyncUpdate(date, people, time, location, notes) {
...
//       `${BASE_URL}/${(date, people, time, location, notes)}`,
//       {
//         method: "PUT",
//         headers: {
//           "content-type": "application/json",
//           Authorization: "Bearer " + tokenService.getToken()
//         },
//         body: JSON.stringify(date, people, time, location, notes)
//       }
//     );
